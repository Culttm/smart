var TestApp = angular.module('testApp',["ngRoute", "app.TestCtrl", "app.TestList"]);



TestApp.run(["$rootScope", "$location", "$anchorScroll", "$window", "$interval", "$log", function($rootScope, $location, $anchorScroll, $window, $interval, $log){
